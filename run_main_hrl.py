...
if __name__ == "__main__":
    ...
    arg.add_arg("env_name", "csi800", "Environment name, can be [hs3300, sp500,nifty100,csi800]")
    arg.add_arg("algo", "dac", "Environment type, can be [dac, hier_ppo]")
    arg.add_arg("device", "cuda:0", "Computing device")
    arg.add_arg("tag", "default", "Experiment tag")
    arg.add_arg("n_epoch", 500, "Number of training epochs")
