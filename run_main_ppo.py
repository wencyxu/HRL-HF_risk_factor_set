...
from model.HRL.option_ppo import PPO
from model.HRL.option_policy import Policy
...
def learn(config: Config, msg="default"):
    ...
    from envir.risk_factor_env_ppo import Risk_Factor_Env as Env
    ...
    if config.algo == 'ppo':
        ...
        raise ValueError("Invalid algorithm. Only 'ppo' is supported.")
...
if __name__ == "__main__":
    ...
    arg.add_arg("env_name", "sh300", "Environment name")
    arg.add_arg("algo", "ppo", "Algorithm type, can only be [ppo]")
