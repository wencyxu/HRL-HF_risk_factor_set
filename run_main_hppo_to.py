...
def learn(config: Config, msg="default"):
    ...
    print(f"Environment dim_c: {dim_c}")
    print(f"Config dim_c: {config.dim_c}")
...
if __name__ == "__main__":
    ...
    arg.add_arg("env_name", "hs300", "Environment name, can be [hs300, sp500, nifty100,csi800]") #???
    ...
    '''hs300, sp500, nifty100,csi800'''
    config.policy_model = "./option_model/0.torch" 
